...
if __name__ == '__main__':
    ...
    policy = Policy(8,2)
    torch.save(policy.model.state_dict(), 'data/init_policy.pt')
    ...
    if sys.argv[1] == 'test':
        ml3_loss.model.load_state_dict(torch.load('data/ml3_loss_reacher.pt'))
        ml3_loss.model.eval()
        opt_iter = 2
        test_goal = np.array(env.get_target_joint_configuration(np.array([0.02534078, 0.19863741, 0.0])))  # 0.02534078, -0.19863741, 0.0
